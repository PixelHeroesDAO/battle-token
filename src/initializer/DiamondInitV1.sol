...
import "../facets/PermissionControlFacet.sol";
...
contract DiamondInit {    
    ...
    function init() external {
        ...
        PHBTFacet(address(this)).initialize(LZ_ENDPOINT, owner_);
        PermissionControlFacet(address(this)).initializePermission(owner_);
    }
